# File: run_oherent_noise_and_pulse.sh

# This synthetic dataset contains the following

#  - 16 MiniSEED files that contain the waveforms, in SDS data structure
#  -  1 StationXML file of infrasound array DIA (see Evers, 2008)
...
# Using the following script, the full recording o process the full recording with 20 second time windows with 90% overlap:
